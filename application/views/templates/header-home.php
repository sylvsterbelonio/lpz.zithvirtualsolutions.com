...
<head>
    ...
    <link href="<?=base_url()?>assets/css/home/bootstrap-icons.css" rel="stylesheet">

    <!-- Libraries Stylesheet -->
    <link href="<?=base_url()?>assets/css/animate/animate.min.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/css/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
